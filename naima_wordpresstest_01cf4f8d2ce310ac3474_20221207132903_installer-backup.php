...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'naima_wordpresstest_01cf4f8d2ce310ac3474_20221207132903_archive.zip';
        const ARCHIVE_SIZE       = '35151765';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '01cf4f8-07132903';
        const SECONDARY_PACKAGE_HASH = 'a5bfae0-07132903';
        const VERSION            = '1.5.1';
